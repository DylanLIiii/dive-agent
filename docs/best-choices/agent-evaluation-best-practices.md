...
- [Opik 与 Bloom 集成方案](../learns/evaluation/opik-bloom-integration.md)
- [Bloom: Seed-driven 行为评估](../learns/evaluation/seed-driven-evaluation/bloom-behavioral-evaluation.md)
